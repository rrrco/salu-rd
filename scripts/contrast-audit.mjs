...
const heroPanel = mix('#062428', heroBloom, 0.32)
...
P('stat numerals white on glass panel', white, heroPanel, 4.5)
P('stat labels teal-100 on glass panel', '#EBF8F9', heroPanel, 4.5)
