    ...
    <>
      ...
      >
        ...
        <p className="hero-desc" style={{ fontSize: '15px', color: 'rgba(255,255,255,0.88)', maxWidth: '720px', lineHeight: '1.75', marginBottom: '36px' }}>
          SALU División Veterinaria provee productos farmacéuticos certificados, biológicos y consumibles veterinarios a distribuidores y vendedores en toda República Dominicana. Abastecimiento de calidad. Entrega confiable. Respaldo científico.
        </p>
        <a href="/productos" className="btn btn-lg">VER TODOS LOS PRODUCTOS</a>
      </section>
        ...
        <div className="wrap">
          <div className="contact-grid">
            ...
            <div className="contact-left">
              ...
              {[
                {
                  label: 'Correo Electrónico', value: 'salusrl.dv@gmail.com',
      ...
      <section id="products" style={{ background: '#0A6973', padding: '60px 30px' }}>
        <div className="wrap">
          ...
          <div style={{ textAlign: 'center' }}>
            <a href="/productos" className="btn btn-lg">VER CATÁLOGO COMPLETO</a>
          </div>
        </div>
      </section>
