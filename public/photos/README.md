...
| `delivery.jpg` | 4:3 | Cajas de producto en su entorno real, o una entrega en curso. |
...
Formato: JPG o WebP. Ancho mínimo recomendado 3000px para `animal.jpg` y 2400px
para `delivery.jpg`. `delivery.jpg` necesita más ancho del que parece: en
escritorio se recorta a una columna vertical angosta, así que la mayor parte del
ancho original se descarta.

> Estado actual: `delivery.jpg` cumple el mínimo (2350x2624, foto de Yahdi Yasya
> vía Unsplash). `animal.jpg` está en 1584x672; alcanza para pantallas medianas
